...
enum cfgrwnx_msg_index {
    ...
    CFGRWNX_DFS_CAC_FINISHED_EVENT,

    CFGRWNX_DFS_CAC_ABORTED_EVENT,
};
...
/// structcure for CFGRWNX_DFS_CAC_FINISHED_EVENT
struct cfgrwnx_dfs_event {
    /// header
    struct cfgrwnx_msg_hdr hdr;
    /// ieee80211_channel center_freq
	u32 center_freq;
    int ht_enabled;
    int chan_offset;
    enum aic_80211_chan_width chan_width;
    int cf1;
    int cf2;
};
/**
