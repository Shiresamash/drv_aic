...
int rwnx_send_roc(struct rwnx_hw *rwnx_hw, unsigned int vif_index, struct ieee80211_channel *chan, unsigned int
duration, struct mm_remain_on_channel_cfm * roc_cfm);
