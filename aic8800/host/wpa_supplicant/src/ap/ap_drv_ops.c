...
void aic_build_interworking_ie(struct hostapd_data *hapd)
{
    hapd->conf->interworking     = aic_interworking_cfg.interworking;
    hapd->conf->access_network_type = aic_interworking_cfg.access_network_type;
    hapd->conf->internet         = aic_interworking_cfg.internet;
    hapd->conf->asra             = aic_interworking_cfg.asra;
    hapd->conf->esr              = aic_interworking_cfg.esr;
    hapd->conf->uesa             = aic_interworking_cfg.uesa;
    hapd->conf->venue_info_set   = aic_interworking_cfg.venue_info_set;
    hapd->conf->venue_group      = aic_interworking_cfg.venue_group;
    hapd->conf->venue_type       = aic_interworking_cfg.venue_type;
}
#endif
