...
#define MHD_MAX_SDPCM_HEADER_LENGTH (22)
#define MHD_ETHERNET_SIZE 		(14)
#define PBUF_LINK_HLEN (MHD_MAX_BUS_HEADER_LENGTH + MHD_MAX_SDPCM_HEADER_LENGTH + MHD_ETHERNET_SIZE)
#endif
...
#else
#define TCPIP_MBOX_SIZE             128 //8
#define TCPIP_THREAD_PRIO           8 //8 //128
...
#define UDP_TTL                     255
#define DEFAULT_UDP_RECVMBOX_SIZE   32 //1
